    ...
    <style>
        * {
        ...
        body::before {
            ...
            width: 100%;
            height: 100%;
            background: url('data:image/svg+xml,<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100"><defs><pattern id="grid" width="20" height="20" patternUnits="userSpaceOnUse"><path d="M 20 0 L 0 0 0 20" fill="none" stroke="rgba(52,58,64,0.03)" stroke-width="1"/></pattern></defs><rect width="100" height="100" fill="url(%23grid)"/></svg>');
            z-index: -1;
        }
        ...
        .main-content::before {
            ...
            right: 0;
            height: 4px;
            background: linear-gradient(90deg, #0d6efd, #495057, #343a40);
    ...
    <nav class="sidebar">
        <div class="sidebar-content">
            ...
            <a href="{{ route('student.interviews.index') }}"
                ...
                <i class="bi bi-calendar-event me-2"></i> Mes entretiens
            </a>
