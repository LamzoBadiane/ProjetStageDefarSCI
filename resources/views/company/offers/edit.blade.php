...
<div class="container py-5">
    <h2 class="text-center text-white mb-5 animate__animated animate__fadeInDown shadow"
    ...
    <form action="{{ route('company.offers.update', $offer->id) }}" method="POST"
        ...
        <div class="mb-4 mt-4">
            ...
            <textarea name="description" id="description" rows="5"
                class="form-control form-control-lg fancy-input" required>{{ old('description', $offer->description) }}</textarea>
        </div>
